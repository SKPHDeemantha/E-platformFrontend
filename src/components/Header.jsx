    ...
    <header className="bg-gradient-to-b from-primary to-red-300 w-full h-[100px] flex justify-center items-center shadow-md">
      ...
      <div className="h-full flex items-center w-full max-w-screen-lg justify-between px-4 md:px-8">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <button type="button" class="text-gray-900 bg-gradient-to-r from-red-200 via-red-300
           to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100
            dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"><Link
            to="/login"            
          >
           Login
          </Link></button>
