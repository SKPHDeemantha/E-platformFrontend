...
export default function SignUpPage() {
  ...
  return (
    <div className="fixed inset-0 bg-black/100 bg-opacity-20 object-cover flex items-center justify-center z-50">
      <img
        src="https://xvuxswvxdsxzfjtsdorn.supabase.co/storage/v1/object/public/images//aaaaaa.jpg"
      ...
      <div className="relative z-10 w-full max-w-lg bg-white  p-8 rounded-lg shadow-2xl">
        ...
        <label className="block mt-4 mb-2 font-medium text-pink-700">
          Password
        </label>
        <input
          type="password"
