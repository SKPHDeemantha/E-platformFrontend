    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <button 
                    className="bg-white shadow-xl rounded-lg text-wrap font-bold text-2xl text-pink-600 p-4"
                    ...
                    <div className="relative w-full max-w-lg bg-white p-8 rounded-lg shadow-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="flex-1">
                                <label className="block mb-2 font-medium text-adminprimary">First Name</label>
                                <input 
                            ...
                            <div className="flex-1">
                                <label className="block mb-2 font-medium text-adminprimary">Last Name</label>
                                <input 
                        ...
                        <label className="block mt-4 mb-2 font-medium text-adminprimary">Password</label>
                        <input 
                            type="password" value={password} onChange={(e) => setPassword(e.target.value)} 
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-adminprimary" 
                            placeholder="Enter your password" />

                        <label className="block mt-4 mb-2 font-medium text-adminprimary">Profile Picture</label>
                        <input 
                            type="file" onChange={(e) => handleImageUpload(e.target.files[0])} 
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-adminprimary" />
